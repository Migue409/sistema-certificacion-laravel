                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color: white; padding: 20px; text-align: center;">
                    <tr>
                        <td style="font-size: 18px; color: #333;">
                            ...
                            <p>Te recordamos que has agendado una cita para la actividad extracurricular: <strong>{{$actividad}}</strong></p>
                            <p>Fecha: <strong>{{$fecha}}</strong></p>
                            <p>Aula: <strong>{{$aula}}</strong></p>
                            <p>Docente: <strong>{{$docente}}</strong></p>
                            <p style="margin-top: 20px; font-weight: bold; color: #555;">
                                De parte de la Coordinación de Inglés te deseamos éxito en tus actividades.
                            </p>
                        </td>
                    </tr>
                </table>
